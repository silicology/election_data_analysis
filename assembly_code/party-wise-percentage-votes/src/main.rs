...
fn main() {
    ...
    let input_path = "data/2024_assembly/analysis/party_wise_votes_haryana.json";
    ...
    let output_path = "data/2024_assembly/analysis/percentage_votes_state_wise_haryana.json";
